...
import datetime
import json
from app.storeman.stores import jd
import itertools
import mimetypes
import hashlib
...
class RestApi(object):
    ...
    def __init__(self, domain='gw.storeman.360buy.net', port=80):
    ...
    #     url = url + "?" + urllib.parse.urlencode(sys_parameters)
    #     print(url)
    #     # params = json.dumps(application_parameter, ensure_ascii=False, default=lambda value: value.decode('utf-8'))
