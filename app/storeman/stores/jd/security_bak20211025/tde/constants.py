# -*- coding:utf-8 -*-
from app.main.stores.jd.security.tde.tde_exceptions import MalformedException
...
class CipherTypes(object):
    __WEAK = CipherType(b'\x00')
    __REGULAR = CipherType(b'\x01')
    __LARGE = CipherType(b'\x02')
